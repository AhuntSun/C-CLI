...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(75, 400);
			this->groupBox1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Padding = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox1->Size = System::Drawing::Size(681, 126);
			...
			this->numericUpDown8->Location = System::Drawing::Point(560, 89);
			this->numericUpDown8->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown8->Name = L"numericUpDown8";
			this->numericUpDown8->Size = System::Drawing::Size(56, 25);
			...
			this->numericUpDown7->Location = System::Drawing::Point(464, 88);
			this->numericUpDown7->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown7->Name = L"numericUpDown7";
			this->numericUpDown7->Size = System::Drawing::Size(56, 25);
			...
			// numericUpDown6
			// 
			this->numericUpDown6->Location = System::Drawing::Point(195, 81);
			...
			this->numericUpDown6->Size = System::Drawing::Size(56, 25);
			...
			// numericUpDown5
			// 
			this->numericUpDown5->Location = System::Drawing::Point(96, 80);
			...
			this->label8->Location = System::Drawing::Point(517, 95);
			...
			this->label7->Location = System::Drawing::Point(144, 94);
			...
			this->label6->Location = System::Drawing::Point(517, 40);
			...
			this->label5->Location = System::Drawing::Point(152, 38);
			...
			// numericUpDown4
			// 
			this->numericUpDown4->Location = System::Drawing::Point(560, 32);
			...
			// numericUpDown3
			// 
			this->numericUpDown3->Location = System::Drawing::Point(464, 34);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(192, 30);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(96, 30);
			this->numericUpDown1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown1->Name = L"numericUpDown1";
			this->numericUpDown1->Size = System::Drawing::Size(56, 25);
			...
			this->label4->Location = System::Drawing::Point(342, 91);
			...
			this->label2->Location = System::Drawing::Point(363, 40);
			...
			this->groupBox4->Location = System::Drawing::Point(867, 38);
			...
			this->groupBox4->Size = System::Drawing::Size(212, 255);
			...
			this->button2->Location = System::Drawing::Point(11, 218);
			this->button2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(72, 31);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"宋体", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->button1->Location = System::Drawing::Point(107, 218);
			...
			this->comboBox5->Location = System::Drawing::Point(88, 181);
			this->comboBox5->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->comboBox5->Name = L"comboBox5";
			this->comboBox5->Size = System::Drawing::Size(80, 23);
			...
			this->comboBox4->Location = System::Drawing::Point(88, 125);
			this->comboBox4->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->comboBox4->Name = L"comboBox4";
			this->comboBox4->Size = System::Drawing::Size(80, 23);
			...
			this->comboBox2->Location = System::Drawing::Point(88, 72);
			this->comboBox2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->comboBox2->Name = L"comboBox2";
			this->comboBox2->Size = System::Drawing::Size(80, 23);
			...
			this->comboBox1->Location = System::Drawing::Point(88, 32);
			this->comboBox1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->comboBox1->Name = L"comboBox1";
			this->comboBox1->Size = System::Drawing::Size(80, 23);
			...
			this->label29->Location = System::Drawing::Point(16, 184);
			this->label29->Name = L"label29";
			this->label29->Size = System::Drawing::Size(52, 15);
			...
			this->label28->Location = System::Drawing::Point(16, 128);
			...
			this->label26->Location = System::Drawing::Point(16, 72);
			...
			this->label25->Location = System::Drawing::Point(16, 32);
			...
			// numericUpDown25
			// 
			this->numericUpDown25->Location = System::Drawing::Point(108, 39);
			this->numericUpDown25->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown25->Name = L"numericUpDown25";
			this->numericUpDown25->Size = System::Drawing::Size(80, 25);
			...
			this->label30->Location = System::Drawing::Point(19, 41);
			this->label30->Name = L"label30";
			this->label30->Size = System::Drawing::Size(69, 15);
			...
			this->仿真设置ToolStripMenuItem->Size = System::Drawing::Size(81, 24);
			this->仿真设置ToolStripMenuItem->Text = L"仿真设置";
			this->仿真设置ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form1::仿真设置ToolStripMenuItem_Click);
			// 
			// 帮助ToolStripMenuItem
			// 
			...
			this->groupBox6->Location = System::Drawing::Point(867, 320);
			...
			this->groupBox6->Size = System::Drawing::Size(212, 222);
			...
			this->button7->Font = (gcnew System::Drawing::Font(L"宋体", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->button7->Location = System::Drawing::Point(33, 175);
			this->button7->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(72, 31);
			...
			this->button6->Location = System::Drawing::Point(32, 138);
			...
			this->button5->Location = System::Drawing::Point(33, 94);
			this->button5->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(72, 32);
			...
			this->label31->Location = System::Drawing::Point(12, 34);
			this->label31->Name = L"label31";
			this->label31->Size = System::Drawing::Size(82, 15);
			...
			this->listBox1->Location = System::Drawing::Point(15, 52);
			this->listBox1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->listBox1->Name = L"listBox1";
			this->listBox1->ScrollAlwaysVisible = true;
			this->listBox1->Size = System::Drawing::Size(807, 334);
			...
			this->ClientSize = System::Drawing::Size(1091, 554);
...
#pragma endregion
		...
		private:String^ str1;
				...
				array<float>^ lssj = gcnew array<float>(4);//临时数据
				array<float>^BZsj = gcnew array<float>(4);//标准数据

				private:void fangzheng_fasong(void)//数据仿真和发送
				{
					for (int i = 0; i < 3; i++)
					{
						lssj[0] = BZsj[0] + rand()%3;
						lssj[1] = BZsj[1] + rand() % 10;
						lssj[2] = BZsj[2] + rand() % 2;
						lssj[3] = BZsj[3] + rand() % 15;
...
private: System::Void 仿真设置ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
}
};
}
