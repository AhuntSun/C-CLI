...
namespace EXP1 {
	...
	public:
		...
		[Marshal As(UnmanagedType::ByValTStr, SizeConst = 80)]

		String^ szTypeName;

	};

	[Dll Import ("shell32.dll") ]
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->splitContainer1->Size = System::Drawing::Size(752, 448);
			...
			this->splitContainer2->Size = System::Drawing::Size(752, 399);
			...
			this->statusStrip1->Size = System::Drawing::Size(250, 22);
			...
			this->treeView1->Size = System::Drawing::Size(250, 399);
			...
			this->splitContainer3->Size = System::Drawing::Size(498, 399);
			...
			this->listView1->Size = System::Drawing::Size(498, 316);
			...
			this->button4->Location = System::Drawing::Point(384, 24);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"宋体", 10.5F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->button3->Location = System::Drawing::Point(264, 24);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"宋体", 10.5F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->button2->Location = System::Drawing::Point(136, 24);
			...
			this->label2->Location = System::Drawing::Point(456, 16);
			...
			this->ClientSize = System::Drawing::Size(752, 448);
...
private: System::Void On_AfterSel(System::Object^  sender, System::Windows::Forms::TreeViewEventArgs^  e) {
	...
	try{ dirs = Directory::GetDirectories(curPath); }
	...
	if (files->Length > 0) {
		...
		for (int i = 0; i < files->Length; i++) {
			...
			if (fInfo->Length > 1024)
				...
				items[i]->SubItems->Add(String::Concat((fInfo->Length / 1024).ToString(), "K"));
	...
	toolStripStatusLabel1->Text = String::Concat("在目录【", curPath, "】下，有 ",
		...
		dirs->Length.ToString(), " 个子目录，有 ",

		files->Length.ToString(), " 个文件！");
}
