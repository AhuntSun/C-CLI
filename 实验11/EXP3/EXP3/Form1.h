...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->字体OToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->toolStrip1->Size = System::Drawing::Size(664, 25);
			...
			this->menuStrip1->Size = System::Drawing::Size(664, 25);
			...
			this->退出XToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form1::exitMenu_Click);
			// 
			...
			this->toolStripSeparator6->Size = System::Drawing::Size(158, 6);
			// 
			...
			this->工具TToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->自动换行CToolStripMenuItem,
					this->字体OToolStripMenuItem, this->计算器ToolStripMenuItem
			});
			...
			this->自动换行CToolStripMenuItem->Size = System::Drawing::Size(140, 22);
			...
			// 
			this->字体OToolStripMenuItem->Name = L"字体OToolStripMenuItem";
			this->字体OToolStripMenuItem->Size = System::Drawing::Size(140, 22);
			this->字体OToolStripMenuItem->Text = L"字体(&O)";
			this->字体OToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form1::On_Font);
			// 
			// 计算器ToolStripMenuItem
			// 
			this->计算器ToolStripMenuItem->Name = L"计算器ToolStripMenuItem";
			this->计算器ToolStripMenuItem->Size = System::Drawing::Size(140, 22);
			...
			this->toolStripSeparator7->Size = System::Drawing::Size(122, 6);
			// 
			...
			this->textBox1->Location = System::Drawing::Point(0, 50);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->ScrollBars = System::Windows::Forms::ScrollBars::Both;
			this->textBox1->Size = System::Drawing::Size(664, 363);
			...
			this->ClientSize = System::Drawing::Size(664, 413);
...
private: System::Void exitMenu_Click(System::Object^  sender, System::EventArgs^  e) {
	if (this->textBox1->Modified) {
		...
		if (MessageBox::Show(L"是否保存文件?", L"提示", MessageBoxButtons::OKCancel) == System::Windows::Forms::DialogResult::OK) // 保存提示

			saveMenu_Click(sender, e);  // 保存数据
