...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(427, 880);
			...
			this->button2->Location = System::Drawing::Point(608, 880);
			...
			this->button3->Location = System::Drawing::Point(789, 880);
			...
			this->pictureBox2->Location = System::Drawing::Point(3, 20);
			this->pictureBox2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(239, 258);
			...
			this->pictureBox3->Location = System::Drawing::Point(3, 20);
			this->pictureBox3->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->pictureBox3->Name = L"pictureBox3";
			this->pictureBox3->Size = System::Drawing::Size(239, 258);
			...
			this->pictureBox4->Location = System::Drawing::Point(3, 20);
			this->pictureBox4->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->pictureBox4->Name = L"pictureBox4";
			this->pictureBox4->Size = System::Drawing::Size(239, 258);
			...
			this->pictureBox5->Location = System::Drawing::Point(3, 20);
			this->pictureBox5->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->pictureBox5->Name = L"pictureBox5";
			this->pictureBox5->Size = System::Drawing::Size(239, 258);
			...
			this->pictureBox6->Location = System::Drawing::Point(3, 20);
			this->pictureBox6->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->pictureBox6->Name = L"pictureBox6";
			this->pictureBox6->Size = System::Drawing::Size(239, 258);
			...
			this->numericUpDown2->Location = System::Drawing::Point(544, 470);
			this->numericUpDown2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown2->Name = L"numericUpDown2";
			this->numericUpDown2->Size = System::Drawing::Size(245, 25);
			...
			this->numericUpDown3->Location = System::Drawing::Point(907, 470);
			this->numericUpDown3->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown3->Name = L"numericUpDown3";
			this->numericUpDown3->Size = System::Drawing::Size(245, 25);
			...
			this->numericUpDown4->Location = System::Drawing::Point(181, 810);
			this->numericUpDown4->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown4->Name = L"numericUpDown4";
			this->numericUpDown4->Size = System::Drawing::Size(245, 25);
			...
			this->numericUpDown5->Location = System::Drawing::Point(544, 810);
			this->numericUpDown5->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown5->Name = L"numericUpDown5";
			this->numericUpDown5->Size = System::Drawing::Size(245, 25);
			...
			this->numericUpDown6->Location = System::Drawing::Point(907, 810);
			this->numericUpDown6->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown6->Name = L"numericUpDown6";
			this->numericUpDown6->Size = System::Drawing::Size(245, 25);
			...
			this->label1->Location = System::Drawing::Point(1003, 20);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(203, 40);
			this->label1->TabIndex = 15;
			this->label1->Text = L"选手";
			this->label1->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			this->label1->Click += gcnew System::EventHandler(this, &Mark::label1_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Size = System::Drawing::Size(239, 258);
			...
			this->numericUpDown1->Location = System::Drawing::Point(181, 470);
			this->numericUpDown1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->numericUpDown1->Name = L"numericUpDown1";
			this->numericUpDown1->Size = System::Drawing::Size(248, 25);
			...
			this->groupBox1->Location = System::Drawing::Point(181, 190);
			this->groupBox1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Padding = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox1->Size = System::Drawing::Size(245, 280);
			this->groupBox1->TabIndex = 18;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"评委1";
			// 
			// groupBox2
			// 
			this->groupBox2->BackColor = System::Drawing::Color::Red;
			this->groupBox2->Controls->Add(this->pictureBox2);
			this->groupBox2->Location = System::Drawing::Point(544, 190);
			this->groupBox2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Padding = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox2->Size = System::Drawing::Size(245, 280);
			this->groupBox2->TabIndex = 19;
			this->groupBox2->TabStop = false;
			this->groupBox2->Text = L"评委2";
			// 
			// groupBox3
			// 
			this->groupBox3->BackColor = System::Drawing::Color::Red;
			this->groupBox3->Controls->Add(this->pictureBox4);
			this->groupBox3->Location = System::Drawing::Point(907, 190);
			...
			this->groupBox3->Size = System::Drawing::Size(245, 280);
			this->groupBox3->TabIndex = 20;
			this->groupBox3->TabStop = false;
			this->groupBox3->Text = L"评委3";
			// 
			// groupBox4
			// 
			this->groupBox4->BackColor = System::Drawing::Color::Red;
			this->groupBox4->Controls->Add(this->pictureBox3);
			this->groupBox4->Location = System::Drawing::Point(181, 530);
			...
			this->groupBox4->Size = System::Drawing::Size(245, 280);
			this->groupBox4->TabIndex = 21;
			this->groupBox4->TabStop = false;
			this->groupBox4->Text = L"评委4";
			// 
			// groupBox5
			// 
			this->groupBox5->BackColor = System::Drawing::Color::Red;
			this->groupBox5->Controls->Add(this->pictureBox5);
			this->groupBox5->Location = System::Drawing::Point(544, 530);
			...
			this->groupBox5->Size = System::Drawing::Size(245, 280);
			this->groupBox5->TabIndex = 22;
			this->groupBox5->TabStop = false;
			this->groupBox5->Text = L"评委5";
			// 
			// groupBox6
			// 
			this->groupBox6->BackColor = System::Drawing::Color::Red;
			this->groupBox6->Controls->Add(this->pictureBox6);
			this->groupBox6->Location = System::Drawing::Point(907, 530);
			...
			this->groupBox6->Size = System::Drawing::Size(245, 280);
			this->groupBox6->TabIndex = 23;
			this->groupBox6->TabStop = false;
			this->groupBox6->Text = L"评委6";
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		publish->label1->Text = thestu->fScore[6].ToString();
		publish->label2->Text = this->label1->Text;
